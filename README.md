...
- Todos os vídeos foram gravados, foi utilizado a aplicação que enviada ao ECS e se conectando ao RDS PostgreSQL, Event Bridge e AWS SQS
...
````
#### Veículos
Também não será permitido a inicialização de estacionamento por tempo fixo ou variável, se o condutor não tiver veiculos cadastros, ou métodos de pagamento condizentes com o tipo de estacionamento que ele escolheu.
...
De acordo com o zona azul, o preço por 60 minutos estacionado, é de R$ 6,08. Mas se o condutor permanecer estacionado por 30 minutos, ou 2 horas quanto ele pagaria? Para isso utilizamos a regra de três. Veja o exemplo abaixo
...
## Como iniciar um estacionamento por tempo fixo ou por tempo variável
